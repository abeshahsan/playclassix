		...
		<aside className='hidden lg:flex lg:w-60 flex-col fixed top-14 bottom-0 left-0 z-40 border-r border-sidebar-border bg-sidebar-bg overflow-y-auto'>
				...
				<div className='p-4 border-b border-sidebar-border'>
					<div className='flex items-center gap-3'>
						...
						<div className='flex-1 min-w-0'>
							<p className='text-sm font-semibold text-text-primary truncate'>{gamer.ign}</p>
							<p className='text-xs text-text-tertiary'>Player</p>
						</div>
					</div>
				</div>
			)}
			...
			<nav className='flex-1 px-3 py-4 space-y-1'>
				...
				<div className='pt-4 mt-4 border-t border-sidebar-border'>
					<p className='px-3 mb-2 text-xs font-semibold uppercase tracking-wider text-text-tertiary'>Games</p>
					{games.map((game) => {
