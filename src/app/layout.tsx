...
export const metadata: Metadata = {
	...
	openGraph: {
		...
		description: "Play a variety of classic games online with friends and players around the world.",
		images: [
			{
	...
	twitter: {
		...
		title: "PlayClassix — Classic Online Games for Everyone",
		description: "Play a variety of classic games online with friends. Free in your browser.",
